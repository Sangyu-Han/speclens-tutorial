...
md("""
**shortcut도 트리로 — 모델은 왜 apple이라 했나.** apple logit을 미는 layer4 feature 중 **패치 feature
f566이 1위**입니다. 노드 클릭 → 패치 붙은 apple에서 어디에 반응하는지 보입니다: f566은 **마젠타 코너**
(가짜 단서)에, 진짜 apple feature는 **사과 몸통**에. (~10초)
""")

code('''
# shortcut 모델의 "왜 apple인가" 트리 (apple ← layer4 feature, 패치 f566 이 지배)
