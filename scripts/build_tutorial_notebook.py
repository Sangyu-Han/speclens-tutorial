...
""")
code("# !python scripts/train_sae_config.py --config configs/cifar_cnn_sae_colab.yaml   # ~5분, 5개 레이어 동시 학습")
...
!python scripts/cifar_misclass_tree.py --true bicycle --pred motorcycle --ckpt {ART}/cnn.pt --sae-root {ART}/sae --index-dir {ART}/index --data-root ./data --out-dir {ART}/misclass --device {DEVICE}
from IPython.display import Image, display
import glob
